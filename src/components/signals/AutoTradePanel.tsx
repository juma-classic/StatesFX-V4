...
import { type AutoTradeConfig, autoTrader, type StateFXStats } from '../../services/auto-trader.service';
...
export const AutoTradePanel: React.FC = () => {
    ...
    const [stats, setStats] = useState<StateFXStats>(autoTrader.getStats());
